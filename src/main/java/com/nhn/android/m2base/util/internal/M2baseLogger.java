...
public class M2baseLogger {
	...
	public boolean isDebugEnabled() {
		if (debugEnabled == null) {
			return M2baseLogger.DEBUG_MODE;
		}
	...
	public boolean isErrorEnabled() {
		if (errorEnabled == null) {
			return M2baseLogger.LOG_ON_ERROR;
		}
	...
	private M2baseLogger(String category) {
	...
	public static M2baseLogger getLogger(String category) {
		M2baseLogger logger = new M2baseLogger(category);
		logger.setTAG("#M2# " + category);
		return logger;
	}

	@SuppressWarnings("rawtypes")
	public static M2baseLogger getLogger(Class clazz) {

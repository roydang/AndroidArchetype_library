...
public class ThemeHelper {
	...
	public static synchronized void updateTheme() {
	...
	public static void getInstalledThemeList(final String permission, GetThemeListListener listener) {
	...
	public static void getInstalledThemeList(ThemePackageFilter filter, GetThemeListListener listener) {
	...
	public static List<String> getInstalledThemeListSync(String permission) {
		BaseApplication application = BaseApplication._internalInstance;
	...
	public static List<String> getInstalledThemeListSync(ThemePackageFilter filter) {
		BaseApplication application = BaseApplication._internalInstance;
	...
	public static Resources getThemeResources() {
		if (isThemeInstalled()) {
	...
	public static int getThemeId(String packageName, String defName, String name) {
		if (isThemeInstalled()) {
	...
	public static int getThemeId(Resources res, String packageName, String defName, String name) {
		return res.getIdentifier(name, defName, packageName);
	}
	
	public static int getThemeId(int id) {
		BaseApplication application = BaseApplication._internalInstance;
	...
	public static Drawable getThemeDrawable(String name) {
		return getThemeDrawable(name, true);
	}
	
	public static Drawable getThemeDrawable(String name, boolean loadDefault) {
		BaseApplication application = BaseApplication._internalInstance;
	...
	public static Drawable getThemeDrawable(int id) {
		return getThemeDrawable(id, true);
	}
	
	public static Drawable getThemeDrawable(int id, boolean loadDefault) {
		BaseApplication application = BaseApplication._internalInstance;
	...
	public static int getThemeColor(String name) {
		return getThemeColor(name, true);
	}
	
	public static int getThemeColor(String name, boolean loadDefault) {
		BaseApplication application = BaseApplication._internalInstance;
	...
	public static Integer getThemeColor(int id) {
		return getThemeColor(id, true);
	}
	
	public static Integer getThemeColor(int id, boolean loadDefault) {
		BaseApplication application = BaseApplication._internalInstance;
	...
	public static void overrideAttributes(View v, AttributeSet attrs) {
	...
	public static boolean isNhnOfficialTheme() {
		BaseApplication application = BaseApplication._internalInstance;

package com.nhn.android.archetype.base.util;
...
public class BaseLogger {
	...
	private BaseLogger(String category) {
	...
	public static BaseLogger getLogger(String category) {
		BaseLogger logger = new BaseLogger(category);
		logger.setTAG("#M2 base# " + category);
		return logger;
	}

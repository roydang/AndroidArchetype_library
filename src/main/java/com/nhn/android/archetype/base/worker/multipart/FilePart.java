...
public class FilePart extends PartBase {
    ...
    throws IOException {
        //Utility.d("FilePart", "enter sendDispositionHeader(OutputStream out)");
    ...
    protected void sendData(OutputStream out) throws IOException {
        //Utility.d("FilePart", "enter sendData(OutputStream out)");
        if (lengthOfData() == 0) {

            // this file contains no data, so there is nothing to send.
            // we don't want to create a zero length buffer as this will
            // cause an infinite loop when reading.
        	//Utility.d("FilePart", "No data to send.");
            return;
        }

        byte[] tmp = new byte[8 * 1024]; // 8k이상으로.. 올림
    ...
    protected PartSource getSource() {
        //Utility.d("FilePart", "enter getSource()");
        return this.source;
    }
    ...
    protected long lengthOfData() {
        //Utility.d("FilePart", "enter lengthOfData()");

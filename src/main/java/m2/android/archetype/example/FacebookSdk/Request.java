...
package m2.android.archetype.example.FacebookSdk;
...
import m2.android.archetype.example.FacebookSdk.internal.Logger;
import m2.android.archetype.example.FacebookSdk.internal.ServerProtocol;
import m2.android.archetype.example.FacebookSdk.internal.Utility;
import m2.android.archetype.example.FacebookSdk.internal.Validate;
import m2.android.archetype.example.FacebookSdk.model.*;
...
public class Request {
     ...
     * {@link Request#executeMeRequestAsync(Session, m2.android.archetype.example.FacebookSdk.Request.GraphUserCallback)}
    ...
    /**
     * Specifies the interface that consumers of
     * {@link Request#executeMyFriendsRequestAsync(Session, m2.android.archetype.example.FacebookSdk.Request.GraphUserListCallback)}
     * can use to be notified when the request completes, either successfully or with an error.
     */
    ...
    /**
     * Specifies the interface that consumers of
     * {@link Request#executePlacesSearchRequestAsync(Session, android.location.Location, int, int, String, m2.android.archetype.example.FacebookSdk.Request.GraphPlaceListCallback)}
     * can use to be notified when the request completes, either successfully or with an error.
     */
